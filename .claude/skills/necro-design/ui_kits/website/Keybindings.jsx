...
function Keybindings() {
  ...
  const rows = [
    { combo: [{label:'Prefix'},{label:'a',tone:'green'},{label:'i',tone:'green'}], name: 'Restore', desc: 'Reanimate the latest snapshot (popup)' },
    { combo: [{label:'Prefix'},{label:'I',tone:'azure'}], name: 'Install', desc: 'Install the plugin via TPM' },
  ];
  return (
