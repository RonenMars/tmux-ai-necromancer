...
# Ask the adapter where transcripts live rather than re-implementing Claude's
# cwd encoding here — a fixture that duplicates the rule can't catch it drifting.
